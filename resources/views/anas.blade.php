...
<html lang="en">
  <head>
	...
	<!-- Font-Awesome -->
    <link href="anas/assets/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	<!-- Lightbox -->
	<link href="anas/assets/lightbox/css/lightbox.css" rel="stylesheet">
    <!-- Text Rotator-->
	<link href="anas/assets/textrotator/simpletextrotator.css" rel="stylesheet">
	<!-- FlexSlider -->
    <link href="anas/assets/flexslider/flexslider.css" rel="stylesheet">
	<!-- Theme Style -->
    <link href="anas/css/style.css" rel="stylesheet">
	<!-- Animations -->
    <link href="anas/css/animate.css" rel="stylesheet">
	<!-- Custom Favicon -->
	<link href="anas/img/favicon.ico" rel="shortcut icon" type="image/x-icon" /> 
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]> -->
    <script src="anas/assets/html5shiv/html5shiv.js"></script>
    <script src="anas/assets/respond/respond.min.js"></script>
    <!--[endif]-->
  </head>
    <body id="top">
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-1 inner">
                  <h1 class="animated fadeInDown">
                    <span style="color:#E04343;">A</span>nas<br/>
                    <span style="color:#E04343;">F</span>adzrin
                  </h1><!-- Title -->
                  <h3 class="animated fadeInUp delay-05s"><span class="rotate">AI Graduate,PHP Developer,REST API</span></h3><!-- Text Rotator -->
                </div>
              </div>
			  <!-- Learn More Button -->
              <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                  <a href="#about" class="scrollto wow fadeInUp delay-5s ">
			            <p>SEE MORE</p>
			            <p class="scrollto--arrow"><img src="anas/img/scroll-down.png" alt="scroll down arrow"></p>
			        </a>
                </div>
              </div>
            </div>
...
<!-- ==========================
            ...
            <div class="row contact-details">
              ...
              <div class="col-md-4">
                <div class="dark-box box-hover">
                  ...
                  <p><a href="https://api.whatsapp.com/send?phone=601126112833"> Whatsapp Me</a></p>
                </div>
              </div>
			  <!-- Phone Number Box -->
              <div class="col-md-4">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-12 text-center">
                <p>All Rights Reserved. &copy; 2023 Anas Fadzrin
              </div>
            </div>
          </div>
        </footer>
    ...
    <!-- SmoothScroll -->           
    <script type="text/javascript" src="anas/assets/smoothscroll/smoothscroll.js"></script>
    <!-- Bootstrap -->
    <script src="anas/assets/bootstrap/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="anas/js/waypoints.min.js"></script>
    <!-- classie.js -->
	<script src="anas/js/classie.js"></script>
    <!-- FlexSlider -->
    <script src="anas/assets/flexslider/jquery.flexslider.js"></script>
	<!-- Modernizr -->
    <script src="anas/js/modernizr.js"></script>
	<!-- Text Rotator -->
	<script src="anas/assets/textrotator/jquery.simple-text-rotator.js"></script>
	<!-- Lightbox.js -->
    <script src="anas/assets/lightbox/js/lightbox.min.js"></script>
    <!-- Google Maps --> 
	...
	<script src="anas/js/main.js"></script>
	<script src="anas/js/script.js"></script>
